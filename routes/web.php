...
Route::middleware(['checkUserSession'])->group(function () {
    ...
    Route::middleware(['checkRole:admin'])->group(function () {
        ...
        Route::post('/dashboard/shifts/{id}/close', [DashboardController::class, 'closeShift'])->name('shift.close');
        ...
        Route::get('/dashboard/shift-cash-print/{id}', [DashboardController::class, 'shiftCashPrint'])
             ->name('shift.cash.print');
          // POS Reprint Route
        Route::get('/pos/order/{order}/print', [POSController::class, 'reprint'])
        ...
        Route::get('/reports/sales', [ReportController::class, 'sales'])
            ->name('reports.sales');
        Route::get('/reports/sales/data', [ReportController::class, 'salesData'])
            ->name('reports.sales.data');
        Route::get('/reports/sales-by-products',[ReportController::class, 'salesByProducts'])
...
//Route::get('/pos/print/{id}', [POSController::class, 'print'])->name('pos.order.print');
Route::get('/pos/kitchen-print/{order}', [POSController::class, 'printKitchenHTML'])
    ->name('pos.kitchen.print');
